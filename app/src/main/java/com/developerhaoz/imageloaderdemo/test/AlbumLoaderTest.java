...
public class AlbumLoaderTest extends CursorLoader {
    ...
    private AlbumLoaderTest(Context context, String selection, String[] selectionArgs){
    ...
    public static CursorLoader newInstance(Context context){
        ...
        return new AlbumLoaderTest(context, selection, selectionArgs);
    }
