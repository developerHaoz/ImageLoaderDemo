...
public class MediaCollection implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return MediaLoader.newInstance(context, album, album.isAll() && args.getBoolean(ARGS_ENABLE_CAPTURE, false));
    }
    ...
    public void onCreate(@NonNull FragmentActivity context, @NonNull MediaCallbacks callbacks){
