...
import com.developerhaoz.imageloaderdemo.internal.loader.AlbumMediaLoader;
...
public class AlbumMeidaCollection implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private AlbumMeidaCallbacks mCallbacks;
    ...
    public void onCreate(@NonNull FragmentActivity context, @NonNull AlbumMeidaCallbacks callbacks){
    ...
    public interface AlbumMeidaCallbacks {
