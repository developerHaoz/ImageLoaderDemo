...
import com.developerhaoz.imageloaderdemo.internal.utils.Platform;
    ...
    private void onItemSelected(Context context, int position) {
        ...
        if (mSelected.getVisibility() == View.VISIBLE) {
            ...
            if (Platform.hasICS()) {
                ...
                mSelected.setText(displayName);
                mSelected.animate().alpha(1.0f).setDuration(500).start();
            } else {
                mSelected.setVisibility(View.VISIBLE);
                mSelected.setText(displayName);
            }
        ...
        mSelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mListPopupWindow.setHeight(
                        mAdapter.getCount() > 6 ? itemHeight * MAX_SHOWN_COUNT
